...
{
    public enum ACC_CONNECTION_STATUS
    {
        DISCONNECTED,
        CONNECTED
    }
    ...
    public delegate void ConnectionStatusChangedHandler(object sender, ConnectionStatusEventArgs e);
    ...
    public class AssettoCorsa
    {
        ...
        public bool IsRunning { get { return connectionStatus == ACC_CONNECTION_STATUS.CONNECTED; } }

        private AC_STATUS gameStatus = AC_STATUS.AC_OFF;

        private ACC_CONNECTION_STATUS connectionStatus;

        public event ConnectionStatusChangedHandler ConnectionStatusChanged;
        public virtual void OnConnectionStatusChanged(ConnectionStatusEventArgs e)
        {
        ...
        private bool ConnectToSharedMemory()
        {
            try
            {
                ...
                connectionStatus = ACC_CONNECTION_STATUS.CONNECTED;
                OnConnectionStatusChanged(new ConnectionStatusEventArgs(connectionStatus));
                return true;
            }
        ...
        public void Stop()
        {
            connectionStatus = ACC_CONNECTION_STATUS.DISCONNECTED;
            OnConnectionStatusChanged(new ConnectionStatusEventArgs(connectionStatus));
            sharedMemoryRetryTimer.Stop();
        ...
        {
            if (connectionStatus == ACC_CONNECTION_STATUS.DISCONNECTED)
                return;
        ...
        {
            if (connectionStatus == ACC_CONNECTION_STATUS.DISCONNECTED || physicsMMF == null)
        ...
        {
            if (connectionStatus == ACC_CONNECTION_STATUS.DISCONNECTED || graphicsMMF == null)
                throw new AssettoCorsaNotStartedException();
        ...
        {
            if (connectionStatus == ACC_CONNECTION_STATUS.DISCONNECTED || staticInfoMMF == null)
                throw new AssettoCorsaNotStartedException();
